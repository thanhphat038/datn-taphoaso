    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 p-8">
        <div className="mb-8 flex justify-between items-center">
          ...
          <NavLink to="/admin/addvoucher" className="bg-[#06AEF4] text-white px-4 py-2 rounded-md flex items-center gap-2 hover:bg-[#0590d8] transition-colors duration-300">
