...
const ProductDetail = () => {
    ...
    const product = useProductDetailData(id) || {};
        ...
        <main className="container mx-auto py-10 px-4">
            <div className="flex flex-wrap lg:flex-nowrap gap-8">
                ...
                <div className="w-full lg:w-1/2 flex flex-col items-center">
                    <img src={product.image} alt={product.name} className="w-full max-w-md rounded-lg shadow-lg" />
                ...
                <div className="w-full lg:w-1/2">
                    ...
                    <div className="mb-4">
                        ...
                        {product.price && (
                            <span className="text-gray-500 line-through">{product.price} vnd</span>
                        )}
                    </div>
                    ...
                    <div className="flex items-center mb-4">
                        ...
                        {/* <span className="ml-2 text-gray-600 text-sm">{product.rating} đánh giá</span> Placeholder */}
                    </div>
